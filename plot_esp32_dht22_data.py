...
The data path this is intended to be used with is:
...
#
# Currently runs only on the windows (and probably Mac) desktop, until I can
# find out how to install libcblas.so on the raspberry.
#
import argparse
import datetime
import math
